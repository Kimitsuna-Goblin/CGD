...
# normal test
# qs is given by qs <- c( qnorm( 0.3, -0.2, 1 ), 0, qnorm( 0.7, 0.2, 0.8 ) ); a$set.waypoints( data.frame( p = c( 0.3, 0.5, 0.7 ), q = qs ), this.type1.type = 2, continuous = TRUE ); a$q( c( 0.1, 0.25, 0.4, 0.5, 0.6, 0.75, 0.9 ) )
