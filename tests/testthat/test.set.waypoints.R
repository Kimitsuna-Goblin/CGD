...
# normal test - bug fix (for v2.3.0, and up)
qs <- c( -2.3, -0.2, 0, 0.2 )
a$set.waypoints(
    data.frame(
    p = c( 0.1, 0.4, 0.5, 0.6 ),
...
# normal test - bug fix (for 3.3.0, and up)
a$set.waypoints(
    data.frame(
    p = c( 0.1, 0.4, 0.501, 0.6, 0.8 ),
    q = qs ),
    this.type1.type = 4 )
expect_equal( c( a$sd, a$lsd, a$usd ), c( 1.279807, 1.238636, 1.319695 ), tolerance = 5e-7 )
expect_equal( a$p( qs ), c( 0.1, 0.4, 0.501, 0.6, 0.8 ), tolerance = 5e-7 )
plot.waypoints.and.p( a,
    c( 0.1, 0.4, 0.501, 0.6, 0.8 ), qs, c( -3, 3 ) )
plot( seq( -3, 3, 0.01 ), a$d( seq( -3, 3, 0.01 ) ), type = "l" )
show.results()
...
# normal test for 3.3.0, and up
qs <- c( qnorm( 0.1, 0, 0.9 ), qnorm( 0.25, 0, 0.95 ),
         0, qnorm( 0.75, 0, 1.1 ), qnorm( 0.9, 0, 1.13 ) )
a$set.waypoints(
        data.frame(
        p = c( 0.1, 0.5, 0.6, 0.75, 0.9 ),
        q = qs ),
        this.type1.type = 4 )
expect_equal( c( a$sd, a$lsd, a$usd ), c( 1.0558497, 0.9107432, 1.1832938 ), tolerance = 5e-7 )
expect_equal( a$p( qs ), c( 0.1, 0.5, 0.6, 0.75, 0.9 ), tolerance = 5e-7 )
plot.waypoints.and.p( a,
    c( 0.1, 0.5, 0.6, 0.75, 0.9 ), qs, c( -3, 3 ) )
show.results()
...
a$set.waypoints(
        ...
        q = qs ),
        this.type1.type = 4 )
expect_equal( c( a$sd, a$lsd, a$usd ), c( 1.0415349, 1.1222272, 0.9540419 ), tolerance = 5e-7 )
expect_equal( a$p( qs ), c( 0.1, 0.25, 0.4, 0.5, 0.9 ), tolerance = 5e-7 )
plot.waypoints.and.p( a,
    c( 0.1, 0.25, 0.4, 0.5, 0.9 ), qs, c( -3, 3 ) )
show.results()
...
a$set.waypoints(
        ...
        q = qs ),
        this.type1.type = 4 )
expect_equal( c( a$sd, a$lsd, a$usd ), c( 1.0203671, 1.0696231, 0.9686096 ), tolerance = 5e-7 )
expect_equal( a$p( qs ), c( 0.1, 0.25, 0.4, 0.6, 0.9 ), tolerance = 5e-7 )
plot.waypoints.and.p( a,
    c( 0.1, 0.25, 0.4, 0.6, 0.9 ), qs, c( -3, 3 ) )
show.results()
